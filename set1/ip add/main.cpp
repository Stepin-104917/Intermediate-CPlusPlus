...
IPAddress::IPAddress(int i1,int i2, int i3, int i4 ) : ipval(to_string(i1)+"."+to_string(i2)+"."+to_string(i3)+"."+to_string(i4))
{
}

IPAddress::IPAddress(int i) : ipval(to_string(i)+"."+to_string(i)+"."+to_string(i)+"."+to_string(i)) 
{
}
